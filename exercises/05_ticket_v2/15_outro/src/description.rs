...
fn str_to_description(value: &str) -> Result<TicketDescription, DescriptionError> {
    match value.len() {
        0 => Err(DescriptionError::EmptyDescription),
        1..=50 => Ok(TicketDescription(value.to_string())),
        _ => Err(DescriptionError::DescriptionTooLong),
    }
}
...
impl TryFrom<String> for TicketDescription {
    ...
    fn try_from(value: String) -> Result<Self, Self::Error>{
        str_to_description(value.as_str())
    }
}
